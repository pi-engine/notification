...
INSERT INTO `notification_id_value` (`id`, `title`, `type`, `time_create`, `time_update`, `time_delete`)
VALUES (1, 'Firebase', 'platform', 1650735005, 0, 0),
...
INSERT INTO `notification_message` (`id`, `title`, `text`, `image`, `link`, `time_create`, `time_update`, `time_delete`)
VALUES (1, 'Test', 'This is a test for check api response', '', '', 1650733902, 0, 0);

INSERT INTO `notification_noti` (`id`, `sender_id`, `receiver_id`, `platform`, `provider`, `target`, `type`, `status`,
                                 `message_id`, `parent_id`, `time_create`, `time_update`, `time_delete`)
VALUES (1, 10, 11, 1, 1, 6, 10, 0, 1, 0, 1650733902, 0, 0);
